...
{
  /// <summary>
  /// Klasse zum Verarbeiten eines Deflate-Headers
  /// </summary>
  public sealed class InflaterDynHeader
  {
    const int LNUM = 0;
    const int DNUM = 1;
    const int BLNUM = 2;
      ...
      for (; ; )
      {
        switch (mode)
        {
          ...
          case LENS:
          {
            ...
            if (symbol >= 17) lastLen = 0; else if (ptr == 0) throw new Exception();
            repSymbol = symbol - 16;
          }
          mode = REPS;
          goto case REPS;
          case REPS:
          {
            ...
            if (ptr + count > num) throw new Exception();
